  ...
  return `
    <div style="font-family:Arial,Helvetica,sans-serif;background:#f6efe3;padding:32px;color:#24170e">
      <div style="max-width:560px;margin:0 auto;background:#fffaf0;border-radius:24px;padding:32px;border:1px solid rgba(97,61,28,0.12)">
        <p style="margin:0 0 8px;color:#b24b2a;font-size:12px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase">ShareFair Verification</p>
...
function buildSettlementNoticeHtml(input) {
  ...
  return `
    <div style="font-family:Arial,Helvetica,sans-serif;background:#f6efe3;padding:32px;color:#24170e">
      <div style="max-width:560px;margin:0 auto;background:#fffaf0;border-radius:24px;padding:32px;border:1px solid rgba(97,61,28,0.12)">
        <p style="margin:0 0 8px;color:#145e55;font-size:12px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase">ShareFair Social Contract</p>
        ...
        <p style="margin:0;color:#7a5b43;line-height:1.6">ShareFair will keep reminding you as the due time gets closer.</p>
      </div>
    </div>
  `;
}
...
export async function sendStepUpVerificationEmail(input) {
  ...
  const response = await resend.emails.send({
    ...
    to: input.to,
    subject: `Your ShareFair verification code for ${input.tripName || "your trip"}`,
