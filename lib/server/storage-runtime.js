...
async function createSchema() {
  ...
  await sql`ALTER TABLE settlement_requests ADD COLUMN IF NOT EXISTS paid_at TIMESTAMPTZ`;
  await sql`ALTER TABLE settlement_requests ADD COLUMN IF NOT EXISTS confirmed_at TIMESTAMPTZ`;
  await sql`ALTER TABLE settlement_requests ADD COLUMN IF NOT EXISTS settled_at TIMESTAMPTZ`;
