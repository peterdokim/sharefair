...
describe("trip helper settlement summaries", () => {
  ...
  it("builds the social contract description for eligible categories", () => {
    expect(getSettlementContractDescription("food", "Kim")).toBe(
      "Because this is a food cost, Kim can enforce a due time and ShareFair will email the group immediately, then ping again 3 hours and 15 minutes before the deadline."
    );
  });
