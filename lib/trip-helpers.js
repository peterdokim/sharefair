...
export function getSettlementContractDescription(expenseCategory, payerName = "the payer") {
  ...
  if (category === "food" || category === "transport") {
    return `Because this is a ${category} cost, ${payerName} can enforce a due time and ShareFair will email the group immediately, then ping again 3 hours and 15 minutes before the deadline.`;
  }
